...
#pragma warning disable 0649
            ...
            void Start()
        {
            ...
            //InvokeRepeating("AutoShoot", 0, 0.3f);
        }
        ...
        public void JoyStackMove(Vector2 direction = default(Vector2))
        {
        ...
        void AutoShoot()
        {
            Shoot(turret.transform.forward);
        }
        ...
        {   
            ...
            Vector3 shotCenter = Vector3.Lerp(shotPos.position, new Vector3(xPos/10f, shotPos.position.y + 1.6f, zPos/10f), 0.6f);
            ...
            NetworkIdentity identity = bullets[currentBullet].GetComponent<NetworkIdentity>();
            var i = identity == null? NetworkHash128.Parse(bulletIndex++.ToString()) : identity.assetId;
